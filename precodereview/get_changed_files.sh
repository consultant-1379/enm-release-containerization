...
function get_changed_files() {
    ...
    echo "COMMAND: ${GIT_CMD} pull ${GERRIT_MIRROR}/OSS/com.ericsson.oss.ci.rtd/enm-release-containerization ${GERRIT_REFSPEC}"
    ${GIT_CMD} pull "${GERRIT_MIRROR}"/OSS/com.ericsson.oss.ci.rtd/enm-release-containerization "${GERRIT_REFSPEC}"
